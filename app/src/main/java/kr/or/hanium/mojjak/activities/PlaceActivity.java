...
public class PlaceActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
    private int userId;
    private ArrayList<LinearLayout> llRating = new ArrayList<>();
    private ArrayList<ImageView> ivRating = new ArrayList<>();
    private ArrayList<TextView> tvRating = new ArrayList<>();
